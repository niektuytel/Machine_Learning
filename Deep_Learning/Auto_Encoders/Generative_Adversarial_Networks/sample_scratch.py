...
class GAN():
    def __init__(self):
        ...
        self.combined.extend(self.generator.layers)
        self.combined.extend(self.discriminator.layers)
    ...
    def train(self, X, y, n_epochs, batch_size=128, save_interval=50):
        ...
        for epoch in range(n_epochs):
            ...
            d_loss_real, d_acc_real = self.discriminator.train_on_batch(rand_image, valid)
            d_loss_fake, d_acc_fake = self.discriminator.train_on_batch(gen_image, fake)
