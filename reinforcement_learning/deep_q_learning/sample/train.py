# modified from: https://github.com/uvipen/Tetris-deep-Q-learning-pytorch
...
if __name__ == "__main__":
    ...
    while epoch < opt.num_epochs:
        ...
        print(f"[{epoch}/{opt.num_epochs}], Action: {action}, Score: {final_score}, Tetrominoes {final_tetrominoes}, Cleared lines: {final_cleared_lines}")
